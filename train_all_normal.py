...
for category in classification_category:
    ...
    for i in range(5):
        ...
        torch.save(all_models[i].state_dict(), f'normal_models/{model_names[i]}_{category}_normal.pth')
        print("Testing model...")
...
with open("normal_results/training_losses_normal.json", "w") as file:
        json.dump(training_losses, file)
with open("normal_results/training_accuracies_normal.json", "w") as file:
        json.dump(training_accuracies, file)
with open("normal_results/test_accuracies_normal.json", "w") as file:
        json.dump(test_accuracies, file)
with open("normal_results/test_losses_normal.json", "w") as file:
        json.dump(test_losses, file)
with open("normal_results/all_missclassifications_normal.json", "w") as file:
        json.dump(all_missclassifications, file)
with open("normal_results/all_classes_correct_normal.json", "w") as file:
        json.dump(all_classes_correct, file)
with open("normal_results/all_classes_total_normal.json", "w") as file:
        json.dump(all_classes_total, file)
with open("normal_results/all_classes_normal.json", "w") as file:
        json.dump(all_classes, file)
with open("normal_results/training_times_normal.json", "w") as file:
